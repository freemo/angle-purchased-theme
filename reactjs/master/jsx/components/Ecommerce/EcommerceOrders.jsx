...
import EcommerceOrdersRun from './EcommerceOrders.run';
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td className="text-center">
                                <span className="label label-info">Standby</span>
                            </td>
                            <td className="text-center">
                        ...
                        <tr>
                            ...
                            <td>-</td>
                            <td className="text-center">
                                <span className="label label-inverse">Canceled</span>
                            </td>
                            <td className="text-center">
                                <button type="button" className="btn btn-sm btn-default">
                                    <em className="fa fa-search"></em>
                        ...
                        <tr>
                            ...
                            <td>-</td>
                            <td className="text-center">
                                <span className="label label-purple">Shipped</span>
                            </td>
                            <td className="text-center">
                                <button type="button" className="btn btn-sm btn-default">
                                    <em className="fa fa-search"></em>
