...
(function() {
    ...
    function FlotChartController($scope, ChartData, $timeout) {
        ...
        function activate() {
          ...
          // BAR
          // ----------------------------------- 
          vm.barData = ChartData.load('/api/chart/bar.json');
          vm.barOptions = {
              series: {
                  bars: {
                      align: 'center',
          ...
          // BAR STACKED
          // ----------------------------------- 
          vm.barStackeData = ChartData.load('/api/chart/barstacked.json');
          ...
          // SPLINE
          // ----------------------------------- 
          vm.splineData = ChartData.load('/api/chart/spline.json');
          vm.splineOptions = {
              series: {
                  lines: {
                      show: false
          ...
          // AREA
          // ----------------------------------- 
          vm.areaData = ChartData.load('/api/chart/area.json');
          vm.areaOptions = {
              series: {
                  lines: {
                      show: true,
          ...
          // LINE
          // ----------------------------------- 
          vm.lineData = ChartData.load('/api/chart/line.json');
          vm.lineOptions = {
              series: {
                  lines: {
                      show: true,
          ...
          // vm.pieData = ChartData.load('/api/chart/pie.json');
          vm.pieOptions = {
              series: {
                  pie: {
                      show: true,
          ...
          // Direct data temporarily added until fix: https://github.com/flot/flot/pull/1462
          // vm.donutData = ChartData.load('/api/chart/donut.json');
          vm.donutOptions = {
              series: {
                  pie: {
                      show: true,
